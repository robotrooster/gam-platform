---
scope: tenant
title: Checking the status of your maintenance request
---
After you file a maintenance request, you don't have to wonder what's happening with it. GAM keeps you updated as your landlord works through it.

Open **Maintenance** (in your Communication dashboard) and select your request to see its current status. A request typically moves through these stages:

- Open — received and waiting for your landlord to review it
- Assigned — handed to a contractor or maintenance person
