...
If your bank or card issuer refuses a card payment, a flat $1.00 declined-payment fee applies to that attempt. Since a declined attempt doesn't collect any money, the fee can't be charged to that card — it's added to your balance and collected with your next successful payment. It applies each time an attempt is refused, so if a card keeps getting declined it's worth updating your payment method or switching to a bank account before trying again. Declined bank (ACH) payments work differently and are covered by the returned-payment rules, not this fee.
...
Have a question about a specific charge or a payment that didn't go through? We can help, and anything involving moving or refunding money is handed to a human GAM Strategist.
