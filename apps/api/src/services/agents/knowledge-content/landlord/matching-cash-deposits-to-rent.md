...
There is one case GAM settles without asking: the tenant reported the deposit themselves **and** the bank confirms it. That is two independent facts agreeing, neither of them a guess, so it needs nobody in the loop.
