  ...
  async execute(args, actor: AgentActor) {
    ...
    const insp = inspectionId
      ? await queryOne<InspectionUnitRow>(
          `SELECT i.id, i.inspection_type, i.status, i.guided_walkthrough_declined, u.unit_number, u.bedrooms, u.bathrooms, u.unit_type, u.dwelling_ownership, u.is_multi_level, u.is_ada_accessible, u.living_areas, u.features
