 ...
 * near their parks — is the opposite direction and lives in routes/background.
 *
 * RADIUS. Default 50 miles, not the 25 a city product would use: GAM's parks
 * are rural (Amado, Yarnell, Mattoon) and 25 miles around Yarnell contains
 * almost nothing. The renter can widen it, which is the part Nic asked for —
