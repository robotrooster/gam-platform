...
const DOCS: Doc[] = [
  ...
  // September 2011 revision (re-posted February 2026).
  {
    ...
    disclosureType: 'renovation_notice', jurisdiction: 'US', appliesTo: 'rental', unitTypes: DWELLINGS,
    sourceName: 'U.S. Environmental Protection Agency',
  ...
  // fetched — its site blocks automated downloads — and are added by hand.
  {
    ...
    sourcePage: 'https://acis.cals.arizona.edu/community-ipm/public-health-ipm/bed-bugs',
