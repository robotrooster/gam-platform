            ...
            <div style={{ marginBottom: 20, padding: '12px 14px', background: 'var(--bg-2)', border: '1px solid var(--border-0)', borderRadius: 10 }}>
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer' }}>
                ...
                <div style={{ fontSize: '.78rem', color: 'var(--text-2)', lineHeight: 1.5 }}>
                  {/* S636/S640: the links are inside the <label>, so without
                      stopPropagation a click toggles the checkbox instead of
                      opening the document. URLs come from lib/marketing so a
                      missing build var can't ship a localhost link. */}
                  I agree to the{' '}
